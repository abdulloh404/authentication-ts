        ...
        switch (_a.label) {
            case 0:
                ...
                mailOptions = {
                    ...
                    text: "Please verify your account by clicking the link: \nhttp://".concat(environment_1.config.host, "/confirmation/").concat(token),
                };
...
var sendResetPasswordEmail = function (email, token) { return __awaiter(void 0, void 0, void 0, function () {
    var transporter, mailOptions;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                mailOptions = {
                    ...
                    text: "You requested a password reset. Click the link below to reset your password: \nhttp://".concat(environment_1.config.host, "/reset-password/").concat(token),
                };
                return [4 /*yield*/, transporter.sendMail(mailOptions)];
            case 1:
                _a.sent();
